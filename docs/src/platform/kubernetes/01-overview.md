...
[`platform/core/kubernetes/provision/main.tf`](https://github.com/kbntx-org/nexus/blob/main/platform/core/kubernetes/provision/main.tf){ target="\_blank" rel="noopener" }
...
The Terraform under
[`platform/core/kubernetes/provision/`](https://github.com/kbntx-org/nexus/blob/main/platform/core/kubernetes/provision/){ target="\_blank" rel="noopener" }
is thin — it composes a reusable
[`k3s` module](https://github.com/kbntx-org/nexus/tree/main/platform/modules/k3s){ target="\_blank" rel="noopener" }
...
3. **Cluster bootstrap.** Right after k3s is up, the control plane runs
   [`init-core-cluster-dependencies.sh`](https://github.com/kbntx-org/nexus/blob/main/platform/modules/k3s/config/init-core-cluster-dependencies.sh){ target="\_blank" rel="noopener" },
...
[`platform/core/hetzner-cloud-controller/`](https://github.com/kbntx-org/nexus/tree/main/platform/core/hetzner-cloud-controller){ target="\_blank" rel="noopener" }
...
Two plans live in
[`platform/core/kubernetes/upgrades/plans/`](https://github.com/kbntx-org/nexus/tree/main/platform/core/kubernetes/upgrades/plans){ target="\_blank" rel="noopener" }:
...
[`platform/core/kubernetes/upgrades/system-upgrade-controller/`](https://github.com/kbntx-org/nexus/tree/main/platform/core/kubernetes/upgrades/system-upgrade-controller){ target="\_blank" rel="noopener" }
...
- [`platform/core/kubernetes/provision/`](https://github.com/kbntx-org/nexus/tree/main/platform/core/kubernetes/provision){ target="\_blank" rel="noopener" } — cluster-shape Terraform (control plane, pools, firewalls)
- [`platform/modules/k3s/`](https://github.com/kbntx-org/nexus/tree/main/platform/modules/k3s){ target="\_blank" rel="noopener" } — reusable k3s module (cloud-init, server/agent install, bootstrap)
- [`platform/modules/k3s/config/cloud-init.yml`](https://github.com/kbntx-org/nexus/blob/main/platform/modules/k3s/config/cloud-init.yml){ target="\_blank" rel="noopener" } — the cloud-init that installs k3s on every node
- [`platform/modules/k3s/config/init-core-cluster-dependencies.sh`](https://github.com/kbntx-org/nexus/blob/main/platform/modules/k3s/config/init-core-cluster-dependencies.sh){ target="\_blank" rel="noopener" } — post-install bootstrap (CCM + ArgoCD)
