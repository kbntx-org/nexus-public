...
export const HERO_DATA: HeroData = {
  ...
  subtitle:
    'Passionate about exploring every step of software development, from full-stack development to platform engineering, focusing on optimizing and scaling cloud-based systems for fast, reliable software delivery.',
