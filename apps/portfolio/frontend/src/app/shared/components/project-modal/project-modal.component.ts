...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        class="bg-card border-border fixed bottom-0 left-0 right-0 max-h-[75svh] transform overflow-y-auto rounded-t-2xl border-t shadow-2xl transition-transform duration-300 ease-out lg:hidden"
